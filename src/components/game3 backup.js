...
systemTurn(){
    ...
    //si no lo había disparado a la cell...
        ...
        if (thisShootStatus ===  "shoot") {
            ...
            while(((row + i)  < 12) && (turnTemp === "system") && (systemShootsTemp[(row + i)][col] === "empty")&& ((lastSystemTocadoTemp[3] == 0) || (lastSystemTocadoTemp[3] === "v")  )) {
           ...
           i = - 1
            ...
            while(((row + i)  > 1) && (turnTemp === "system") && (systemShootsTemp[(row + i)][col] === "empty") && ((lastSystemTocadoTemp[3] == 0) || (lastSystemTocadoTemp[3] === "v")  )) {
                    thisShootStatus = userCellsTemp[(row + i)][col] > - 1? "shoot":"no shoot"  
                    systemShootsTemp[(row + i)][col] = userCellsTemp[(row + i)][col]
                ...
                //this.left       
               i = - 1
                while(((col + i)  > 1) && (turnTemp === "system") && (systemShootsTemp[row][(col + i)] === "empty")&& ((lastSystemTocadoTemp[3] == 0) || (lastSystemTocadoTemp[3] === "h")  )) {
                ...
                while (((col + i)  > 1)&& (turnTemp === "system")&& ((lastSystemTocadoTemp[3] == 0) || (lastSystemTocadoTemp[3] === "v")  )) {
